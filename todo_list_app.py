...
class TodoListApp(tk.Tk):
    def __init__(self):
        ...
        self.task_input.insert(0, "Enter Task Here...")
        ...
        ttk.Button(self, text="View Progress", style="info.TButton", command=self.view_stats).pack(side=tk.BOTTOM, pady=10)
    ...
    def clear_placeholder(self, event):
        if self.task_input.get() == "Enter Task Here...":
            self.task_input.delete(0, tk.END)
